...
async def cekidte(client, message):
    ...
    msg = f"""
<blockquote><b>╭──「 🔍 BERINGKUT DATA BELIAU 」</b>
│ 👤 <b>Nama username:</b> {name_link}
│ 🟢 <b>ID Username:</b> <code>{target_user.id}</code> {digit_info}
│ 🔱 <b>Username:</b> {username_text}
│ 🏷️ <b>Data Username:</b> <code>{target_user.dc_id or 'Tidak diketahui'}</code>
